  ...
  return (
    <div>
      <div
        ...
        } border rounded p-3 m-2 max-w-2xl mx-auto bg-slate-50 shadow-xl ${
          showCorrect && "pointer-events-none"
        }`}
      >
        <div className="md:flex justify-between items-center">
          ...
          <button
            ...
            className="font-bold mt-8 md:mt-0 md:ml-8"
            title="Show Answer"
          >
            <FaEye />
          </button>
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 max-w-xl mx-auto gap-3 my-8`}
        >
          {options.map((option) => {
            if (showCorrect) {
              if (option === correctAnswer) {
                return (
                  <button
                    className={`bg-green-600 py-4 px-4 w-full rounded inline-block font-bold text-white`}
                  >
                    {option}
                  </button>
                );
                ...
                return (
                  <button
                    ...
                    className={`bg-violet-600 py-4 px-4 w-full rounded inline-block font-bold text-white`}
                  >
                    {option}
                  </button>
                );
